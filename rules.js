...
function begin_play(){
	...
	if (game_started()){
		// part 5
		alert("Game already started, press reset_play to start again.");
	}
	else{
		// part 1 & 2
		if (isEmpty(player1_name.value) || isEmpty(player2_name.value))
		{
			...
			var x = " (X)";
			var o = " (O)";
			player1_name.value = player1_name.value + x;
			player2_name.value = player2_name.value + o;
			// part 3
...
function play() {
	...
	if (found){
		// part 4
		if (board_state[i] != -1){
			alert("Please pick an empty cell.")
		}
		// part 3
		else{
			if (whose_move()){
